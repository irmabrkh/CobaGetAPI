package com.example.cobagetapi.Fitur
...
import com.example.cobagetapi.ApiClient
import com.example.cobagetapi.R
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnTambah.setOnClickListener {
            ...
            if (nim.isNotEmpty() && nama.isNotEmpty() &&
                ...
                Toast.makeText(this@Insert, "Tolong isi datanya",
                    Toast.LENGTH_SHORT).show()
            }
        }
    }
    private fun insertMahasiswa(nim: String, nama: String, telepon:
    String) {
        ...
        call.enqueue(object : Callback<ResponseDataInsertMahasiswa>
        {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (responseData != null) {
                        ...
                        resultIntent.putExtra("telepon",
                            telepon)
                        setResult(Activity.RESULT_OK,
                            resultIntent)
                        finish()
                    } else {
                        Toast.makeText(this@Insert, "Data Kosong",
                            Toast.LENGTH_SHORT).show()
                    }
                } else {
                    val errorResponse =
            ...
            override fun onFailure(call: Call<ResponseDataInsertMahasiswa>, t: Throwable) {
                ...
                Toast.makeText(this@Insert, "An error occurred",
                    Toast.LENGTH_SHORT).show()
            }
        })
    }
